...
@Component({
    selector     : 'fuse-client-b-analytics-dashboard',
    templateUrl  : './client-b-analytics.component.html',
    styleUrls    : ['./client-b-analytics.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations   : fuseAnimations
})
export class FuseClientBAnalyticsDashboardComponent
{
    widgets: any;
