...
@Component({
    selector     : 'fuse-client-a-analytics-dashboard',
    templateUrl  : './client-a-analytics.component.html',
    styleUrls    : ['./client-a-analytics.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations   : fuseAnimations
})
export class FuseClientAAnalyticsDashboardComponent
{
    widgets: any;
